...
namespace WebVella.ERP {
    public class MimeMapping {
        static private Hashtable _extensionToMimeMappingTable =
            new Hashtable(190, System.StringComparer.CurrentCultureIgnoreCase);
        ...
        public static string GetMimeMapping(string FileName) {
            ...
            if ((0 < extpos) && (extpos > FileName.LastIndexOf('\\'))) {
                contentType = (string) _extensionToMimeMappingTable[FileName.Substring(extpos)];
            }
